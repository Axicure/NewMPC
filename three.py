...
# 假设你的文件名为：
file_paths = {
    'metis': 'metis_results_detailed_15_Services.csv',
    'sandpiper': 'sandpiper_results_detailed_15_Services.csv',
    'random': 'results/10_single_load_0.6cpu_0.8mem_15pm/random_results_detailed.csv',
    'mpc': 'results/10_single_load_0.6cpu_0.8mem_15pm/mpc_results_detailed.csv',
}
...
if data_frames:
    ...
    save_path = 'comparation_results_15_Services'
    plt.savefig(save_path, dpi=300, bbox_inches='tight')
    print(f"图表已成功保存至：{save_path}")
